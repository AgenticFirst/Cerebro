...
const es: TranslationKeys = {
  ...
  variablesHelp: {
    ...
    step1Title: 'Paso 1 \u2014 Preguntar a la IA',
    step1PromptLabel: 'Prompt',
    step1PromptValue: 'Escribe un resumen de hoy en una sola l\u00ednea.',
    step1OutputLabel: 'Produce',
    step1OutputValue: 'Un martes tranquilo y productivo.',
    ...
    exampleCaption: 'El mismo nombre a ambos lados \u2014 el chip del paso 2 es justo el valor que produjo el paso 1.',
    howLabel: 'C\u00f3mo usarlas',
    tip1Title: 'Conecta los pasos',
    tip1Body: 'Arrastra una l\u00ednea desde el paso anterior hasta este. Todo lo que produzca queda disponible aqu\u00ed.',
