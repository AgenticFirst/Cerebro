...
const es: TranslationKeys = {
  ...
  nav: {
    ...
    resetSession: 'Iniciar una sesi\u00f3n nueva',
  ...
  chat: {
    ...
    pasteImageTooLarge: 'Imagen demasiado grande para pegar (máx. 20 MB)',
    ...
    claudeCodeLogin: {
      ...
      body: 'Cerebro perdió la conexión con Claude. Pulsa el botón para iniciar la sesión — abriremos el enlace en tu navegador y reenviaremos tu mensaje automáticamente.',
      startButton: 'Iniciar sesión',
      openLinkButton: 'Abrir enlace de sesión',
      waitingBrowser: 'Esperando a que termines en el navegador…',
      codePlaceholder: 'Pega el código de tu navegador',
      submitCodeButton: 'Enviar código',
      verifying: 'Verificando…',
      retryButton: 'Reintentar',
      codeFailed: 'Ese código no fue aceptado. Abre el enlace de nuevo para obtener uno nuevo.',
      successTitle: 'Sesión iniciada en Claude',
      successBody: 'Reenviando tu mensaje…',
    },
  },
  ...
  files: {
    ...
    previewMissing: 'El archivo ya no existe en esta ubicaci\u00f3n.',
    previewOutsideSafeRoot: 'Este archivo est\u00e1 fuera del \u00e1rea previsualizable.',
    previewParseFailed: 'No se pudo procesar este archivo. \u00c1brelo externamente para verlo.',
    previewParsing: 'Procesando documento\u2026',
    previewLoading: 'Cargando vista previa\u2026',
    previewActionDownload: 'Descargar a ~/Downloads',
    previewActionSaveToFiles: 'Guardar en Archivos',
    previewActionReveal: 'Mostrar en Finder',
    previewActionOpenExternal: 'Abrir con la aplicaci\u00f3n predeterminada',
    previewTabRendered: 'Renderizado',
    previewTabRaw: 'Crudo',
    previewTabExtractedText: 'Texto extra\u00eddo',
    chatPreviewOpen: 'Previsualizar archivo',
  },
  ...
  approvals: {
    ...
    deny: 'Denegar',
    approve: 'Aprobar',
    newToast: 'Una nueva aprobaci\u00f3n espera tu revisi\u00f3n.',
  ...
  integrations: {
    ...
    calendar: {
      ...
      hints: {
        clientId: 'De tu app de Google Cloud o Azure',
  ...
  slackSection: {
    ...
    operatorUserIdLabel: 'ID del operador',
    operatorUserIdHelp:
      'ID de usuario de Slack que recibe el enlace de inicio de sesión de Claude cuando el CLI pierde la autenticación. Déjalo en blanco para usar el primer usuario permitido.',
    ...
    expertAccessTitle: 'Quién puede usar qué expertos',
    expertAccessIntro:
      'Decide qué puede usar todo el mundo en tu workspace de Slack por defecto — no hace falta añadir a cada persona una por una. Después añade excepciones solo para los pocos que necesiten algo distinto.',
    expertAccessExample:
    ...
    expertAccessNoExceptions:
      'Aún no hay excepciones. Todos en Slack siguen el acceso por defecto de arriba.',
    expertAccessAddException: 'Añadir excepción',
    expertAccessModeAll: 'Acceso completo',
  ...
  memory: {
    ...
    noAgentsMatch: 'Ning\u00fan agente coincide con tu b\u00fasqueda.',
    searchPlaceholder: 'Buscar agentes\u2026',
    fileCountTooltip: '{{count}} archivo de memoria',
    fileCountTooltip_plural: '{{count}} archivos de memoria',
    files: 'Archivos',
  ...
  // ── Base de Conocimiento (app estilo Notion) ────────────────
  knowledgeBase: {
    ...
    askAiCollapse: 'Contraer',
    askAiExpand: 'Expandir',
    askAiClose: 'Cerrar',
    askAiNewChat: 'Nueva conversación',
    askAiPlaceholder: 'Pregunta sobre esta página…',
    askAiSend: 'Enviar',
    askAiThinking: 'Pensando…',
    ...
    emptyStateSubtitle: 'Elige una página de la barra lateral o crea una nueva.',
    createFirstPage: 'Crear una página',
    saving: 'Guardando…',
    saved: 'Guardado',
    trash: 'Papelera',
    restore: 'Restaurar',
  ...
  news: {
    ...
    cachedHint: 'Mostrando noticias en caché',
    refresh: 'Actualizar',
    failedToLoad: 'No se pudieron cargar las noticias',
    empty: 'No hay noticias por ahora',
    readerLabel: 'Noticia',
    openOriginal: 'Abrir original',
    sources: 'Fuentes',
    askTitle: 'Pregunta sobre esta noticia',
    askSubtitle: 'Leeré el artículo completo y responderé citando las fuentes.',
    askPlaceholder: 'Pregunta lo que quieras sobre esta noticia…',
    askSend: 'Enviar',
    thinking: 'Pensando…',
    readingArticle: 'Leyendo el artículo…',
    searchingWeb: 'Buscando en la web…',
    askError: 'Algo salió mal al responder eso.',
    suggested: {
  ...
  calendar: {
    title: 'Calendario',
    subtitle: 'Todos tus calendarios en un solo lugar',
    today: 'Hoy',
    refresh: 'Actualizar',
    ...
    noAccounts: 'No hay calendarios conectados',
    noAccountsHint: 'Conecta Google Calendar o Outlook para ver tus eventos aquí.',
    connect: 'Conectar un calendario',
    lastSynced: 'Sincronizado hace {{time}}',
    syncedJustNow: 'Sincronizado ahora mismo',
    allDay: 'Todo el día',
    busy: 'Ocupado',
    free: 'Libre',
    private: 'Privado',
    conflictBadge: 'Cambiado en dos lugares',
    status: {
      connected: 'Conectado',
      tokenExpired: 'Requiere reconexión',
      error: 'Error de sincronización',
      disconnected: 'Desconectado',
    },
    errors: {
      tokenExpired: 'Hay que reconectar {{email}}.',
      syncFailed: 'No se pudo sincronizar {{email}}: {{error}}',
      loadFailed: 'No se pudo cargar tu calendario.',
    },
    event: {
      titleLabel: 'Título',
      whenLabel: 'Cuándo',
      ...
      descriptionLabel: 'Descripción',
      attendeesLabel: 'Invitados',
      attendeesHint: 'Correos separados por comas',
      guestsLocalNote: 'Conecta Google Calendar u Outlook para invitar personas.',
      colorLabel: 'Color',
      calendarLabel: 'Calendario',
      busyLabel: 'Mostrar como ocupado',
      visibilityLabel: 'Visibilidad',
      conferenceLabel: 'Agregar videollamada',
      save: 'Guardar',
      saving: 'Guardando…',
      delete: 'Eliminar',
      cancel: 'Cancelar',
      ...
      deleteConfirm: '¿Eliminar este evento? Se notificará a los invitados.',
    },
    palette: {
      placeholder: 'Escribe un comando o pídelo en lenguaje natural…',
      hint: 'p. ej. "Reunión con John mañana a las 2", "Mueve mi reunión de las 3 al viernes"',
      goToday: 'Ir a hoy',
      weekView: 'Vista semanal',
      dayView: 'Vista diaria',
      newEvent: 'Nuevo evento',
      refresh: 'Actualizar calendarios',
      connect: 'Conectar un calendario',
      parsing: 'Entendiendo…',
      noMatch: 'No pude convertir eso en una acción de calendario.',
      run: 'Ejecutar',
    },
    ai: {
      weekSummary: '¿Cómo se ve mi semana?',
      daySummary: 'Resume mi día',
      thinking: 'Revisando tu calendario…',
      error: 'No se pudo resumir tu calendario.',
    },
    section: {
      title: 'Calendarios',
      description:
      ...
      reconnect: 'Reconectar',
      disconnect: 'Desconectar',
      disconnectConfirm: '¿Desconectar {{email}}? Sus eventos se eliminarán de Cerebro.',
      calendarsHeading: 'Calendarios visibles',
    },
    connectModal: {
      title: 'Conectar un calendario',
      chooseProvider: '¿Qué calendario quieres conectar?',
      google: 'Google Calendar',
      outlook: 'Microsoft Outlook',
      clientIdLabel: 'ID de cliente',
      clientSecretLabel: 'Secreto de cliente',
      authorize: 'Autorizar',
      authorizing: 'Esperando tu navegador…',
      back: 'Atrás',
      next: 'Siguiente',
      cancel: 'Cancelar',
