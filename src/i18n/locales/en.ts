...
const en = {
  ...
  variablesHelp: {
    ...
    step1Title: 'Step 1 — Ask AI',
    step1PromptLabel: 'Prompt',
    step1PromptValue: 'Write a one-line summary of today.',
    step1OutputLabel: 'Produces',
    step1OutputValue: 'A calm, productive Tuesday.',
    step2Title: 'Step 2 — Send Notification',
    step2BodyLabel: 'Message',
    step2BodyPrefix: 'AI said:',
    step2RuntimeLabel: 'Shown on screen',
    exampleCaption: 'Same name on both sides — the chip in step 2 is just the value produced by step 1.',
    howLabel: 'How to use them',
    tip1Title: 'Connect the steps',
    tip1Body: 'Drag a line from the earlier step into this one. Whatever it produces becomes available here.',
