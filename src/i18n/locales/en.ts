...
const en = {
  ...
  integrations: {
    ...
    calendar: {
      name: 'Calendar',
      description: 'Sync Google Calendar and Outlook into one unified, two-way calendar.',
      fields: {
        clientId: 'OAuth Client ID',
        clientSecret: 'OAuth Client Secret',
      },
      hints: {
        clientId: 'From your Google Cloud or Azure app',
  ...
  memory: {
    ...
    fileCountTooltip: '{{count}} memory file',
    fileCountTooltip_plural: '{{count}} memory files',
    files: 'Files',
    newFile: 'New file',
  ...
  knowledgeBase: {
    ...
    askAi: 'Ask AI',
    askAiCollapse: 'Collapse',
    askAiExpand: 'Expand',
    askAiClose: 'Close',
    askAiNewChat: 'New chat',
    askAiPlaceholder: 'Ask about this page…',
    askAiSend: 'Send',
  ...
  news: {
    ...
    cachedHint: 'Showing cached news',
    refresh: 'Refresh',
    failedToLoad: "Couldn't load the news",
    empty: 'No stories right now',
    readerLabel: 'Story',
    openOriginal: 'Open original',
    sources: 'Sources',
    askTitle: 'Ask about this story',
    askSubtitle: 'I’ll read the full article and answer with cited sources.',
    askPlaceholder: 'Ask anything about this story…',
    askSend: 'Send',
    thinking: 'Thinking…',
    readingArticle: 'Reading the article…',
    searchingWeb: 'Searching the web…',
    askError: 'Something went wrong answering that.',
    suggested: {
  ...
  calendar: {
    ...
    noAccounts: 'No calendars connected',
    noAccountsHint: 'Connect Google Calendar or Outlook to see your events here.',
    ...
    free: 'Free',
    private: 'Private',
    conflictBadge: 'Changed in two places',
    status: {
      connected: 'Connected',
      tokenExpired: 'Reconnect needed',
      error: 'Sync error',
    ...
    errors: {
      tokenExpired: '{{email}} needs to be reconnected.',
      syncFailed: "Couldn't sync {{email}}: {{error}}",
      loadFailed: "Couldn't load your calendar.",
    },
    event: {
      titleLabel: 'Title',
      whenLabel: 'When',
      ...
      attendeesHint: 'Comma-separated email addresses',
      guestsLocalNote: 'Connect Google Calendar or Outlook to invite guests.',
      colorLabel: 'Color',
      calendarLabel: 'Calendar',
      busyLabel: 'Show as busy',
      visibilityLabel: 'Visibility',
      conferenceLabel: 'Add video conferencing',
      save: 'Save',
      saving: 'Saving…',
      delete: 'Delete',
      cancel: 'Cancel',
      ...
      rsvpMaybe: 'Maybe',
      organizer: 'Organizer',
      deleteConfirm: 'Delete this event? Guests will be notified.',
    },
    palette: {
      placeholder: 'Type a command or ask in plain English…',
      hint: 'e.g. "Meeting with John tomorrow at 2", "Move my 3pm to Friday"',
      goToday: 'Go to today',
      weekView: 'Week view',
      dayView: 'Day view',
      newEvent: 'New event',
      ...
      noMatch: "I couldn't turn that into a calendar action.",
      run: 'Run',
    },
    ai: {
    ...
    section: {
      title: 'Calendars',
      description: 'Connect Google Calendar and Outlook. Two-way sync keeps everything current.',
      addAccount: 'Add account',
      reconnect: 'Reconnect',
      disconnect: 'Disconnect',
      disconnectConfirm: 'Disconnect {{email}}? Its events will be removed from Cerebro.',
      calendarsHeading: 'Visible calendars',
    },
    connectModal: {
      title: 'Connect a calendar',
      chooseProvider: 'Which calendar do you want to connect?',
      google: 'Google Calendar',
      outlook: 'Microsoft Outlook',
      clientIdLabel: 'Client ID',
      clientSecretLabel: 'Client Secret',
      authorize: 'Authorize',
      authorizing: 'Waiting for your browser…',
      back: 'Back',
      next: 'Next',
      cancel: 'Cancel',
      success: 'Connected {{email}}',
