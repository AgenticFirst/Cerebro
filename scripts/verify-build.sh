...
echo "[verify-build] running electron-forge package…"
npx electron-forge package > /tmp/cerebro-verify-build.log 2>&1 || {
  echo "[verify-build] package step failed. Last 30 lines of log:"
  tail -30 /tmp/cerebro-verify-build.log
  exit 1
}
